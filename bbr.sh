#!/usr/bin/env bash
#
# Instalador de Kernel TCP BBR
#
# URL: https://pwr.org.mx/vpspack
#
...
[[ -d "/proc/vz" ]] && echo -e "${red}Error:${plain} Tu VPS es basado en OpenVZ, el cual no es soportado." && exit 1
...
echo " Kernel  : $kern"
echo "----------------------------------------"
echo " Instalador del Kernel TCP BBR"
echo
echo " URL: https://pwr.org.mx/vpspack"
echo "----------------------------------------"
echo
